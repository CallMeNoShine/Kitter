...
<body>
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="nav-sidebar-container">
                <ul>
                    ...
                    <li>
                        <a class="active" href="mood.php"><img class="nav-sidebar-icon" src="assets/img/smile.svg"></img> ประเมินอารมณ์</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="info.php"><img class="nav-sidebar-icon" src="assets/img/info.svg"></img> ความช่วยเหลือ</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row-10">
                <h1 class="mood-head">อารมณ์ของคุณวันนี้</h1>
                <div class="mood-group container-fluid row input-group">
                    <img class="mood-result" src="assets/img/2.png">
                    <img class="mood-result" src="assets/img/2.png">
                </div>
            </div>
        </div>
